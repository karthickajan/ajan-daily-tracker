"""
Ajan Daily Tracker - Flask Version for PythonAnywhere
Simpler deployment with Flask framework
"""
...
<body>
    <div class="container">
        ...
        <div class="main-grid">
            ...
            <div class="trackers-column">
                <!-- Health & Wellness -->
                <div class="card">
                    <h2 class="card-title">💪 Health & Wellness</h2>
                ...
                <div class="button-group">
                    <button class="btn btn-primary" onclick="saveEntry()">💾 Save Today's Progress</button>
                    <button class="btn btn-secondary" onclick="exportData()">📤 Export Data</button>
                </div>

                <!-- History -->
                <div class="card">
                    <h2 class="card-title">📅 Last 28 Days</h2>
    ...
    <script>
        ...
        function saveEntry() {
            ...
            saveToSupabase(entry).catch(err => {
                console.log('Supabase sync failed, using local storage');
            });
        ...
        async function saveToSupabase(entry) {
            try {
                ...
                console.log('Supabase connection unavailable');
            }
        }
